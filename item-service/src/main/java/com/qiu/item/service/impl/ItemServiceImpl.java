...
public class ItemServiceImpl extends ServiceImpl<ItemMapper, Item> implements IItemService {
    ...
    public void deductStock(List<OrderDetailDTO> items) {
        String sqlStatement = "com.qiu.item.mapper.ItemMapper.updateStock";
        boolean r = false;
        try {
